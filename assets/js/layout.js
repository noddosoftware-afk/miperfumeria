...
const ICON = {
  ...
  carrito:'<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M3 4h2l2.4 12.2a2 2 0 0 0 2 1.6h7.8a2 2 0 0 0 2-1.6L21 8H6"/><circle cx="10" cy="20" r="1.4"/><circle cx="18" cy="20" r="1.4"/></svg>',
...
<svg viewBox="0 0 300 46" aria-label="miperfumeria">
  ...
  <g fill="none" stroke="${c}" stroke-width="1.8" stroke-linejoin="round">
    <rect x="240" y="23" width="19" height="10"/>
    <path d="M240 23 L249.5 17 L259 23"/>
    <circle cx="249.5" cy="15" r="2"/>
  </g>
</svg>`;
}
  ...
  <div class="wrap">
    <div class="header-main">
      ...
      <div class="header-actions">
        ...
        <a class="hicon" href="catalogo.html?f=favoritos">${ICON.fav}<span class="sr">Favoritos</span><em class="cart-count" id="favCount">0</em></a>
